...
export default function Edit({auth,errors,item}) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('roles.update',[{id:item.id}]));
    };
    ...
    return (
        <Authenticated         
          auth={auth}
          errors={errors}
          header={<h1 className="font-semibold text-2xl text-white leading-tight">Edit Item</h1>}
        >
